...
public class OptionsLocalProxyPanel extends AbstractParamPanel {
	...
	private JPanel getPanelLocalProxy() {
		if (panelLocalProxy == null) {
			...
			panelLocalProxy.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "로컬 프록시", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.PLAIN, 11), java.awt.Color.black));
			jLabel.setText("주소 (예시 로컬호스트, 127.0.0.1)");
	...
	private JPanel getPanelReverseProxy() {
		if (panelReverseProxy == null) {
			...
			panelReverseProxy.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "리버스 프록시", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.PLAIN, 11), java.awt.Color.black));
			...
			jLabel2.setText("주소(Address) (예 192.168.0.1)");
			jLabel3.setText("HTTP 포트 (예 80)");
			...
			jLabel5.setText("HTTPS 포트 (예 443)");
			...
			jLabel7.setText("<html><body><p>주소는 \"localhost\" 가 되면 안됩니다. 왜냐하면, 리버스 프록시는 또 다른 컴퓨터에 있는 브라우저를 접속해야하기 때문입니다 .</p></body></html>");
	...
	private void initialize() {
        ...
        this.setName("로컬 프록시(Local proxy)");
	...
	public void validateParam(Object obj) throws Exception {
	    ...
	    try {
	        ...
	        throw new Exception("인식되지 않은 프록시 포트 번호 입니다.");
	    }
	    ...
	    try {
	        ...
	        throw new Exception("인식되지 않은 리버스 프록시 포트 번호 입니다.");
	    }
	...
	private JCheckBox getChkReverseProxy() {
		if (chkReverseProxy == null) {
			...
			chkReverseProxy.setText("리버스 프록시 이용");
