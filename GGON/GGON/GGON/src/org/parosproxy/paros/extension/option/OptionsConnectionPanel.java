...
public class OptionsConnectionPanel extends AbstractParamPanel {
	...
	private JCheckBox getChkUseProxyChain() {
		if (chkUseProxyChain == null) {
			...
			chkUseProxyChain.setText("외부 프록시 서버 이용");
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jLabel5.setText("주소/도메인 이름:");
			jLabel6.setText("포트 (예 8080):");
			jLabel7.setText("<html><p>아래에 있는 도메인 이름이나 IP 주소는 넘겨주세요 (임의의 문자기호는 '*'로, 이름은 ';'로 나뉘어 집니다.):</p></html>");
			...
			jPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "프록시 체인 사용", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.PLAIN, 11), java.awt.Color.black));
	...
	private JPanel getPanelProxyAuth() {
		if (panelProxyAuth == null) {
			...
			jLabel9.setText("범위:");
			jLabel10.setText("사용자 이름:");
			jLabel11.setText("저장할 비밀번호:");
			panelProxyAuth.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "프록시 인증", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", java.awt.Font.PLAIN, 11), java.awt.Color.black));
	...
	public void validateParam(Object obj) throws Exception {
	    ...
	    if (chkUseProxyChain.isSelected()) {
            try {
                ...
                throw new Exception("인증되지 않은 프록시 체인 포트 번호입니다..");
            }
	...
	public void saveParam(Object obj) throws Exception {
	    ...
	    if (chkUseProxyChain.isSelected()) {
            try {
                ...
                txtProxyChainPort.requestFocus();
                throw new Exception("인증되지 않은 프록시 체인 포트 번호 입니다.");
            }
	...
	private JCheckBox getChkProxyChainAuth() {
		if (chkProxyChainAuth == null) {
			...
			chkProxyChainAuth.setText("외부 프록시 서버는 인증이 필요합니다.");
