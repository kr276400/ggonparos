...
public class LicenseFrame extends AbstractFrame {
	...
	private void showLicense(int page) {
	    ...
	    switch (page) {
	    	case 0:
	    	    localUrl = "파일:" + System.getProperty("user.dir") + System.getProperty("file.separator") + "license/TheClarifiedArtisticLicense.htm";
	    	    break;
	    }
	    try{
			...
			e.printStackTrace();
      		JOptionPane.showMessageDialog(new JFrame(), "에러: 파일을 찾지 못하였습니다. 프로그램이 종료됩니다.");
      		System.exit(0);
    	}
    }
